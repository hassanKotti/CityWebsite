<nav class="navbar transparent navbar-inverse ">
    <div class="container navbar-inner">
        <a class="navbar-brand" href="#">
            <button class="side-menu__toggler s-m__trigger side-menu__left side-menu__toggler--close" type="button"
                data-toggle="collapse" data-target="#sidebar-wrapper" aria-controls="sidebar-wrapper"
                aria-expanded="false" onclick="openNav()" aria-label="{{ __('Toggle navigation') }}">
